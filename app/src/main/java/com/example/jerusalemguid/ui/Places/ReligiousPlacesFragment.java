...
public class ReligiousPlacesFragment extends Fragment implements PlacesAdapter.ItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_palaces, container, false);
        rv = root.findViewById(R.id.rvPalaces);
    ...
    private void GetAllPlaces() {
        ...
        db.collection("Places").whereEqualTo("type", "اماكن دينية").get()
