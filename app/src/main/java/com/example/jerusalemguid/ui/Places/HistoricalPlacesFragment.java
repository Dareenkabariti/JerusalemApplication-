...
public class HistoricalPlacesFragment extends Fragment implements PlacesAdapter.ItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv = root.findViewById(R.id.rvMuseums);
    ...
    private void GetAllPlaces() {
        ...
        db.collection("Places").whereEqualTo("type", "اماكن اثرية").get()
                        ...
                        if (documentSnapshots.isEmpty()) {
                            ...
                            for (DocumentSnapshot documentSnapshot : documentSnapshots) {
                                if (documentSnapshot.exists()) {
                                    ...
                                    String desc = documentSnapshot.getString("descriptions");
                                    String type = documentSnapshot.getString("type");
                                    String history = documentSnapshot.getString("history");
                                  Double  lat1 = documentSnapshot.getDouble("lat1");
                                    Double lat2 = documentSnapshot.getDouble("lat2");
